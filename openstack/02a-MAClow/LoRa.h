#ifndef OPENWSN_LORA_H
#define OPENWSN_LORA_H
...
enum lora_atomicdurations_enum {
// time-slot related
#if SLOTDURATION == 10
...
// TX
#define DURATION_tt1 lora_vars.lastCapturedTime+TsTxOffset-delayTx-maxTxDataPrepare
#define DURATION_tt2 lora_vars.lastCapturedTime+TsTxOffset-delayTx
#define DURATION_tt3 lora_vars.lastCapturedTime+TsTxOffset-delayTx+wdRadioTx
#define DURATION_tt4 lora_vars.lastCapturedTime+wdDataDuration
#define DURATION_tt5 lora_vars.lastCapturedTime+TsTxAckDelay-TsShortGT-delayRx-maxRxAckPrepare
#define DURATION_tt6 lora_vars.lastCapturedTime+TsTxAckDelay-TsShortGT-delayRx
#define DURATION_tt7 lora_vars.lastCapturedTime+TsTxAckDelay+TsShortGT
#define DURATION_tt8 lora_vars.lastCapturedTime+wdAckDuration
// RX
#define DURATION_rt1 lora_vars.lastCapturedTime+TsTxOffset-TsLongGT-delayRx-maxRxDataPrepare
#define DURATION_rt2 lora_vars.lastCapturedTime+TsTxOffset-TsLongGT-delayRx
#define DURATION_rt3 lora_vars.lastCapturedTime+TsTxOffset+TsLongGT
#define DURATION_rt4 lora_vars.lastCapturedTime+wdDataDuration
#define DURATION_rt5 lora_vars.lastCapturedTime+TsTxAckDelay-delayTx-maxTxAckPrepare
#define DURATION_rt6 lora_vars.lastCapturedTime+TsTxAckDelay-delayTx
#define DURATION_rt7 lora_vars.lastCapturedTime+TsTxAckDelay-delayTx+wdRadioTx
#define DURATION_rt8 lora_vars.lastCapturedTime+wdAckDuration
// serialInhibit
#define DURATION_si  lora_vars.slotDuration-SERIALINHIBITGUARD
